 ...
 *
 * @file pcb.h
 * @brief Dichiarazione delle funzioni che gestiscono la coda e l'albero dei
 * PCB.
 */
...
/**
 * @brief Inizializza la lista pcbFree in modo da contenere tutti gli elementi
 * della pcbFree_table.
 *
 * */
...
/**
 * @brief Restituisce NULL se pcbFree_h è vuota. Altrimenti rimuove un elemento
 * da pcbFree, inizializza tutti i campi (NULL/0) e restituisce l’elemento
 * rimosso.
 *
...
/**
 * @brief Restituisce TRUE se la lista puntata da head è vuota, FALSE
 * altrimenti.
 *
...
/**
 * @brief Inserisce l’elemento puntato da p nella coda dei processi puntata da
 * head.
 *
...
/**
 * @brief  Restituisce il primo elemento nella lista. Se la lista è vuota il
 * risultato è NULL.
 *
 * @param head Puntatore alla lista di cui va restituito il primo elemento
 *
 * @return NULL se la lista è vuota, altrimenti il puntatore al primo pcb in
 * lista
 */
extern pcb_t *head_proc_q(struct list_head *);

/**
 * @brief Rimuove il primo elemento presente nella lista data. Se la lista è
 * vuota il risultato è NULL.
 *
...
/**
 * @brief Elimina il pcb "p" dalla lista data e lo restituisce. Se p non è
 * presente, il risultato è NULL.
 *
...
/**
 * @brief Restituisce TRUE se il PCB puntato da p non ha figli, FALSE
 * altrimenti.
 *
...
/**
 * @brief  Rimuove il PCB puntato da p dalla lista dei figli del padre.  A
 * differenza della removeChild, p può trovarsi in una posizione arbitraria
 * (ossia non è necessariamente il primo figlio del padre).
 *
 * @param p il processo da rimuovere dalla lista dei figli del proprio processo
 * padre.
 * @return NULL se il PCB puntato da p non ha un padre, altrimenti restituisce
 * l’elemento rimosso.
 */
